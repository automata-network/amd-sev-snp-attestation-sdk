...
enum Commands {
    ...
    /// Prove an already published remote ZK program
    ProveRemoteProgram(prove_remote_program::ProveRemoteProgramCli),
...
async fn main() -> anyhow::Result<()> {
    ...
    match &cli.command {
        ...
        Commands::ProveRemoteProgram(cli) => cli.run().await?,
